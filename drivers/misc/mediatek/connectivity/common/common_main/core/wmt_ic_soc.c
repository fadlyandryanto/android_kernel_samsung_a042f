...
static UINT8 WMT_PATCH_PDA_CFG_EVT[] __maybe_unused = { 0x02, 0x01, 0x01, 0x00, 0x00};

static UINT8 WMT_PATCH_ADDRESS_CMD_NEW[] = { 0x01, 0x01, 0x05, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00};

static UINT8 WMT_PATCH_ADDRESS_EVT_NEW[] __maybe_unused = { 0x02, 0x01, 0x01, 0x00, 0x00};
#endif
